    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center mb-6">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-500">Manage reminder types and application settings</p>
        </div>
      </div>
      ...
      <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 border-b border-gray-200 sm:px-6 flex justify-between items-center">
          <h2 class="text-lg font-medium text-gray-900">Reminder Types</h2>
            ...
            <form (ngSubmit)="saveType()" class="space-y-4">
              ...
              <div class="mt-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <span class="text-sm text-gray-900">{{ form.name || 'Type Name' }}</span>
                </div>
              </div>
